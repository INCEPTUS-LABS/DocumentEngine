...
internal static class Canvas2DSceneDiagnosticCollection
{
        ...
        string parameterName)
    {
        ...
        if (Array.Exists(copy, static diagnostic => diagnostic is null))
        {
            throw new ArgumentException(
                "Canvas2D scene diagnostics cannot contain null values.",
                parameterName);
        }
    ...
    internal static bool SequenceEquals(
        ...
        left.AsSpan().SequenceEqual(right.AsSpan(), Comparer);
